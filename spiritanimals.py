...
print("My name Sherie Chandler and my spirit animal is got.")
print("My name is Sherie Chandler and my skills are formidable. ")
print("My name is Sherie Chandler and my super power is elasticity. ")
...
for peep in coolpeeps["all"]:
    print(f"My name is {peep['name]} and my spirit animal is {peep['spirit_animal']}. ")
    print(f"My name is {peep['name']} and my sills are {person['skills']}. ")
    print(f"My name is {peep['name']} and my superpower is {person['superpower']}. ")
    print()
